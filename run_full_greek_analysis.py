...
def parse_arguments():
    ...
    parser.add_argument('--output-dir', type=str, default='full_greek_analysis',
                        help="Base output directory (default: full_greek_analysis)")
    parser.add_argument('--viz-dir', type=str, default='full_greek_visualizations',
                        help="Visualizations directory (default: full_greek_visualizations)")
    
    args = parser.parse_args()
    
    # Add base_output_dir for compatibility with iterate_similarity_weights.py
